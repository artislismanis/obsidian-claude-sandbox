...
export function buildWsUrl(port: number, username?: string, password?: string): string {
	if (username && password) {
		return `ws://${encodeURIComponent(username)}:${encodeURIComponent(password)}@localhost:${port}/ws`;
	}
